...
@Component({
  selector: 'app-request6',
  templateUrl: './request6.component.html',
  styleUrls: ['./request6.component.css']
})
export class Request6Component implements OnInit {
  quests: Question[];
  ...
  ViewWillEnter() {
    ...
    this.database.getQuestion6().subscribe(data => this.quests = data);
