...
@Component({
  selector: 'app-request7',
  templateUrl: './request7.component.html',
  styleUrls: ['./request7.component.css']
})
export class Request7Component implements OnInit {
  quests: Question[];
  ...
  ViewWillEnter() {
    ...
    this.database.getQuestion7().subscribe(data => this.quests = data);
