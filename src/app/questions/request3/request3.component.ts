...
@Component({
  selector: 'app-request3',
  templateUrl: './request3.component.html',
  styleUrls: ['./request3.component.css']
})
export class Request3Component implements OnInit {
  quests: Question[];
  ...
  ViewWillEnter() {
    ...
    this.database.getQuestion3().subscribe(data => this.quests = data);
