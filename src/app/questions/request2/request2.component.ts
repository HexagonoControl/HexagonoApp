...
@Component({
  selector: 'app-request2',
  templateUrl: './request2.component.html',
  styleUrls: ['./request2.component.css']
})
export class Request2Component implements OnInit {
  quests: Question[];
  ...
  ViewWillEnter() {
    ...
    this.database.getQuestion2().subscribe(data => this.quests = data);
