...
echo "</pre>";
     ...
     //   $data[$i] = "('$id_question', '$id_subcategory')";
        $sentencia = $connect->prepare("insert into qrequest(id_question, id_subcategory,observacion,options) VALUES ($id_question,$id_subcategory,'$observacion','$options')");
        ...
        $sentencia->bindParam("':options'",$observacion, PDO::PARAM_STR);
        $sentencia->execute();
        var_dump($sentencia);
